...
This policy applies to the PeakURL application runtime (`server/`), user interface (`ui/`), installation and database migration services, and official deployment assets maintained within this repository.
