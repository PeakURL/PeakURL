...
The main TypeScript surface in this repo is the React dashboard under `client/`. The PHP runtime in `server/` and root entrypoints follows separate standards.
