 ...
 *
 * Thrown in controllers, feature services, or data layers when a request
 * cannot be fulfilled. The Application kernel catches it and converts it
 * into a JsonResponse::error() result.
 *
 * @since 1.0.0
 */
