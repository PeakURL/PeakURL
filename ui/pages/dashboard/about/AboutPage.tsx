...
const LANDING_META = {
	install: {
		...
		actions: [
			{ label: 'Create your first short link', to: '/dashboard/links' },
			{ label: 'Review general settings', to: '/dashboard/settings/general' },
			{ label: 'Connect location data', to: '/dashboard/settings/location' },
		],
	},
	update: {
		eyebrow: 'Update Complete',
		title: 'PeakURL has been updated successfully.',
		description:
		...
		actions: [
			{ label: 'Check email configuration', to: '/dashboard/settings/email' },
			{ label: 'Verify update status', to: '/dashboard/settings/updates' },
			{ label: 'Open all links', to: '/dashboard/links' },
		],
	},
};

const LandingBanner = ({ source }) => {
	const meta = LANDING_META[source];
...
const FREEDOMS = [
	{
		number: '0',
		title: 'Use',
		description: 'Run PeakURL for any purpose — personal projects, business, education, or anything in between.',
	},
	{
		number: '1',
		title: 'Study',
		description: 'Explore the source code, understand how it works, and modify it to suit your exact needs.',
	},
	{
		number: '2',
		title: 'Share',
		description: 'Redistribute copies freely so others can benefit from the same powerful link management platform.',
	},
	{
		number: '3',
		title: 'Improve',
		description: 'Enhance PeakURL and share your improvements, contributing back to the open-source community.',
	},
];
	...
	return (
		<div className="pb-12">
			...
			<section className="relative overflow-hidden bg-slate-950 -mx-4 sm:-mx-6 -mt-4 sm:-mt-6 px-4 sm:px-6 py-12 sm:py-16 text-white mb-12">
				...
				<div className="relative z-10 text-center max-w-3xl mx-auto">
					...
					<h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4 text-white">
						Welcome to {PEAKURL_NAME}
					</h1>
					<p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
						PeakURL gives you a focused workspace for publishing
						short links, measuring engagement, and running branded
			...
			<div className="max-w-5xl mx-auto space-y-0">
				...
				{/* ─── Features ───────────────────────────────────── */}
				<section>
					<SectionTitle subtitle="Everything you need to publish short links, review traffic, and operate the service from one focused dashboard.">
						What&rsquo;s Inside
					</SectionTitle>
				...
				{/* ─── Mission ────────────────────────────────────── */}
				<section>
				<SectionTitle subtitle="PeakURL is built to stay understandable in day-to-day use and dependable over time.">
					Product Principles
				</SectionTitle>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<div className="bg-surface border border-stroke rounded-xl p-6 text-center">
							...
							<p className="text-sm text-text-muted leading-relaxed">
								The dashboard should stay direct and readable so
								routine work like publishing links, reviewing
								traffic, and managing users does not feel heavy.
							</p>
						</div>
						<div className="bg-surface border border-stroke rounded-xl p-6 text-center">
							<div className="w-12 h-12 mx-auto mb-4 rounded-lg bg-accent/10 flex items-center justify-center">
							...
							<p className="text-sm text-text-muted leading-relaxed">
								The application should install cleanly on common
								PHP and MySQL hosting without depending on a
						...
						<div className="bg-surface border border-stroke rounded-xl p-6 text-center">
							...
							<p className="text-sm text-text-muted leading-relaxed">
								The codebase stays auditable and adaptable so
								operators can understand what they run, extend
								it carefully, and keep long-term control.
							</p>
						</div>
					</div>
				</section>
				...
				{/* ─── Four Freedoms ──────────────────────────────── */}
				<section>
				<SectionTitle subtitle="PeakURL is released under the MIT License so it can stay practical to adopt, inspect, modify, and distribute.">
					Open Source Terms
				</SectionTitle>
				...
				{/* ─── System At A Glance ─────────────────────────── */}
				<section>
				<SectionTitle subtitle="A quick overview of the installation you are running right now.">
