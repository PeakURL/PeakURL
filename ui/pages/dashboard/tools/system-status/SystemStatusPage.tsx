			...
			>
				...
				<div className="system-status-page-issue-meta">
					...
					{isOpen ? (
						<ChevronUp
							size={16}
							className="system-status-page-icon-muted"
						/>
					) : (
						<ChevronDown
							size={16}
...
function IssueSection({
	...
	return (
		<section className="system-status-page-section">
			<div className="system-status-page-section-header">
				<h3 className="system-status-page-section-title">{title}</h3>
				...
				<div className="system-status-page-header">
					<div className="system-status-page-summary">
						...
						<div className="system-status-page-status">
							<span
								className={`system-status-page-status-indicator ${overallTone.ring}`}
							>
								<span
									className={`system-status-page-status-dot ${overallTone.dot}`}
								/>
							</span>
							<span
								className={`system-status-page-status-label ${overallTone.text}`}
							>
								{overallLabel}
							</span>
						</div>
					...
					{'status' === activeView ? (
						<div className="system-status-page-view">
							...
							{passingChecks.length > 0 ? (
								<section className="system-status-page-section">
									<div className="system-status-page-passed-actions">
										<button
											type="button"
											onClick={() =>
												setShowPassedChecks(
						...
						<div className="system-status-page-view-compact">
							...
							<div className="system-status-page-copy-row">
								<button
									type="button"
